...
**What We Measure**:
- Epistemic Validity Score (EV) using 11-axis framework (FSVE §7)
- Uncertainty Mass (UM) - percentage of uncharacterized behavior
- Confidence Ceiling (CC) - maximum justified confidence based on penalties (FSVE §5)
...
## 🔄 Audit Protocol (14-Day Standard Timeline)
...
- Apply confidence ceiling penalties (FSVE §5)
...
> — CTO, Healthcare AI Startup (Anonymous)
...
A: Yes, as long as we have API access or a testing interface. Proprietary architectures are fine—we audit behavior, not source code.
